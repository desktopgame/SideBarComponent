 ...
 * these properties. Also starting in JDK6 the desktop renderering hints will be
 * used to renderer the text. For versions not supporting the rendering hints
 * antialiasing will be turned on.
 */
class TextIcon implements Icon, PropertyChangeListener {
     ...
     * @param component the component to which the icon will be added
     * @param text the text to be rendered on the Icon
     * @param layout specify the layout of the text. Must be one of the Layout
